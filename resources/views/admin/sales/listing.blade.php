                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid" data-kt-select2="true"
                                                ...
                                                data-dropdown-parent="#kt_menu_6308d90415736" data-allow-clear="true">
                                                <option></option>
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    @foreach ($orders as $order)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-5">
                                                        <!--begin::Title-->
                                                        <a href="../../user-management/users/view.html"
                                                            class="text-gray-800 text-hover-primary fs-5 fw-bold">{{ $order->user->address->fname . ' ' . $order->user->address->lname }}</a>
                                                        <!--end::Title-->
                                                    </div>
                                                </div>
                                            </td>
                                            <!--end::Customer=-->
                                            <!--begin::Status=-->
                                            <td class="text-end pe-0" data-order="{{ $order->delivery->name }}">
                                                <!--begin::Badges-->
                                                <div class="badge badge-light-success">
                                                    @if ($order->delivery->name == 'Delivered')
                                                        Delievered
                                                    @else
                                                        {{ $order->delivery->name }}
                                                    @endif
                                            ...
                                            <!--end::Date Added=-->
                                            <!--begin::Date Modified=-->
                                            <td class="text-end" data-order="{{ $order->updated_at->format('Y-m-d') }}">
