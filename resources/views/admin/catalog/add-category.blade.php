        ...
        <div class="d-flex flex-column flex-column-fluid">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid" data-kt-select2="true"
                                                ...
                                                data-dropdown-parent="#kt_menu_6308d90312769" data-allow-clear="true">
                                                <option></option>
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form id="kt_ecommerce_add_category_form" method="post" action="{{ route('category.store') }}"
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <select class="form-select mb-2" name="status" data-control="select2"
                                        ...
                                        @foreach ($status as $status)
                                            <option value="{{ $status->slug }}" {{-- selected="selected" --}}>
                                                {{ $status->name }}
                                            </option>
                                        @endforeach
