        ...
        <div class="d-flex flex-column flex-column-fluid">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid" data-kt-select2="true"
                                                ...
                                                data-dropdown-parent="#kt_menu_6308d90389151" data-allow-clear="true">
                                                <option></option>
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"  enctype="multipart/form-data" method="Post" action="{{route('category.update',$category->id)}}">
                        <!--begin::Aside column-->
                        @method('put')
                        @csrf
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <select class="form-select mb-2" data-control="select2" data-hide-search="true" name="status"
                                        ...
                                        @foreach ($status as $status)
                                            <option value="{{$status->slug}}" {{$status->slug==$category->status ? "Selected":""}}>{{$status->name}}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
