...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/authentication/layouts/creative/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Aug 2022 14:37:44 GMT -->
<!-- Added by HTTrack -->
            ...
            <div class="d-flex flex-center w-lg-50 p-10">
                ...
                <div class="card rounded-3 w-md-550px">
                        ...
                        <div class="alert alert-danger" role="alert">
                            @foreach ($errors->all() as $error)
                                <ul>
                                    ...
                                    justify-content: center;font-size: 130%;">
                                        <li>{{ $error }}</li>
                                    </strong>
                                </ul>
                            @endforeach
                    ...
                    <div class="card-body p-10 p-lg-20">
                        <!--begin::Form-->
                        <form class="form w-100" method="POST" action="{{ route('admin.login') }}" id="kt_sign_in_form"
                            action="#">
                            <!--begin::Heading-->
                            @method('POST')
                            @csrf
                            <div class="text-center mb-11">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder mb-3">Admin Log In</h1>
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                                <div class="text-gray-500 fw-semibold fs-6">Your E-Commerce Dashboard</div>
                                <!--end::Subtitle=-->
                            </div>
                            <!--begin::Heading-->
                            <!--begin::Login options-->
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Email-->
                                <input type="text" placeholder="Email" name="admin_email" autocomplete="off"
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/authentication/layouts/creative/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Aug 2022 14:37:45 GMT -->
